...
ohmage.data.fun = []
//===============================================================================
ohmage.data.filter = function(data){//data is array
    var out = ''
    $.each(data,function(){
